                  ...
                  {slot.type === "date" && (
                    <label className="flex items-center gap-2 cursor-pointer select-none">
                      <input
                        ...
                        className="rounded border-gray-600 bg-[#0a0a0a] text-violet-500 focus:ring-violet-500 focus:ring-offset-0"
                      />
                      <span className="text-xs text-gray-400">Allow past dates</span>
                    </label>
                  )}
