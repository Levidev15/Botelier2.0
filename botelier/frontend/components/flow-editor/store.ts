...
const OPERA_OHIP_BOOKING_TEMPLATE = {
  variables: [
    ...
    { key: "booking_url",         type: "text"   as SlotType, description: "Reservation link returned by Opera",              required: false },
  ],
  nodes: [
    {
      id: "start_1",
...
const GUESTCENTRIC_CRS_BOOKING_TEMPLATE = {
  variables: [
    ...
    { key: "rooms",                  type: "text"   as SlotType, description: "Full room metadata returned by GuestCentric",                       required: false },
    { key: "promotions",             type: "text"   as SlotType, description: "Promotions returned by GuestCentric",                              required: false },
    { key: "first_room_type_code",   type: "text"   as SlotType, description: "First available room type code",                                  required: false },
    { key: "first_room_name",        type: "text"   as SlotType, description: "First available room name",                                       required: false },
    { key: "first_room_description", type: "text"   as SlotType, description: "First available room description",                                required: false },
    { key: "first_room_max_persons", type: "number" as SlotType, description: "First available room maximum occupancy",                           required: false },
    { key: "first_room_max_adults",  type: "number" as SlotType, description: "First available room maximum adults",                              required: false },
    { key: "first_room_amenities",   type: "text"   as SlotType, description: "First available room amenities",                                  required: false },
    { key: "first_rate_plan_code",   type: "text"   as SlotType, description: "First available rate plan code",                                  required: false },
    { key: "first_rate_name",        type: "text"   as SlotType, description: "First available rate name",                                       required: false },
    { key: "first_rate_description", type: "text"   as SlotType, description: "First available rate description",                                required: false },
    { key: "first_room_rate_code",   type: "text"   as SlotType, description: "First available room and rate combination code",                   required: false },
    { key: "first_total_price",      type: "number" as SlotType, description: "First available total stay price",                                 required: false },
    { key: "first_net_price",        type: "number" as SlotType, description: "First available net stay price",                                   required: false },
    { key: "first_pay_now",          type: "number" as SlotType, description: "First available amount due now",                                   required: false },
    { key: "first_currency",         type: "text"   as SlotType, description: "First available price currency",                                  required: false },
    { key: "first_meal_plan_id",     type: "text"   as SlotType, description: "First available included meal plan ID",                            required: false },
    ...
    { key: "policies",               type: "text"   as SlotType, description: "Cancellation policies returned by GuestCentric",                    required: false },
    { key: "first_policy_id",        type: "text"   as SlotType, description: "First cancellation policy ID",                                     required: false },
    { key: "first_policy_name",      type: "text"   as SlotType, description: "First cancellation policy name",                                   required: false },
    { key: "first_policy_teaser",    type: "text"   as SlotType, description: "First cancellation policy teaser",                                 required: false },
    { key: "first_policy_full_text", type: "text"   as SlotType, description: "First cancellation policy full text",                              required: false },
    { key: "first_policy_guarantee_text", type: "text" as SlotType, description: "First cancellation policy guarantee text",                      required: false },
    { key: "first_policy_rule_type", type: "text"   as SlotType, description: "First cancellation policy rule type",                              required: false },
    { key: "first_policy_rule_value", type: "text"  as SlotType, description: "First cancellation policy rule value",                             required: false },
    { key: "first_policy_rule_text", type: "text"   as SlotType, description: "First cancellation policy rule text",                              required: false },
    { key: "reservations",           type: "text"   as SlotType, description: "Reservations returned by GuestCentric",                            required: false },
    { key: "status",                 type: "text"   as SlotType, description: "Raw GuestCentric reservation status",                              required: false },
  ...
  edges: [
    ...
    { id: "e12",  source: "confirm_details",        sourceHandle: "confirmed", target: "create_booking" },
