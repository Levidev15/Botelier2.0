...
class SubAccountManager:
    ...
    def create_sub_account(self, hotel_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            sub_account = self.client.client.api.accounts.create(friendly_name=friendly_name)
            ...
            return {
                ...
                "date_created": sub_account.date_created.isoformat()
                if sub_account.date_created
                else None,
            }
    ...
    def suspend_sub_account(self, sub_account_sid: str) -> bool:
        ...
        """
        try:
            self.client.client.api.accounts(sub_account_sid).update(status="suspended")
            return True
    ...
    def close_sub_account(self, sub_account_sid: str) -> bool:
        ...
        """
        try:
            self.client.client.api.accounts(sub_account_sid).update(status="closed")
            return True
